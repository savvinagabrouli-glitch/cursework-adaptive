...
builder.Configuration.AddJsonFile(sharedCfgPath, optional: true, reloadOnChange: true);

builder.Configuration.AddJsonFile("appsettings.json", optional: true, reloadOnChange: true);

var profile = builder.Configuration["ActiveProfile"] ?? "Local";


QuestPDF.Settings.License = LicenseType.Community;

var cs =
    builder.Configuration[$"Profiles:{profile}:ConnectionStrings:Default"]
